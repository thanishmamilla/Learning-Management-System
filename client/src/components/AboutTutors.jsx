...
const AboutTutors = () => {
  const tutors = [
    ...
    {
      name: "B Deekshitha | COO",
      photoUrl: "/images/profile.png",
      bio: "Deekshitha  is a cybersecurity expert with a backgroud in ethical hacking, security Analyst,Penetration tester ,WAPT, . CEH(v13) | CyberSecurity Trainer |  CyberSecurity Analyst | Penetartion Tester",
    },
  ];

  return (
    <section className="about-tutors py-32 text-white"
    style={{backgroundImage: "url('/images/1010066.jpg')", backgroundSize: "cover", backgroundPosition: "center", height: "100vh"}}>
          ...
          {tutors.map((tutor, index) => (
            ...
            >
              ...
              <h3 className="text-2xl font-semibold text-center mb-2">
                {tutor.name.split('|')[0]}
                <span className="text-lg font-normal"> | {tutor.name.split('|')[1]}</span>
              </h3>
